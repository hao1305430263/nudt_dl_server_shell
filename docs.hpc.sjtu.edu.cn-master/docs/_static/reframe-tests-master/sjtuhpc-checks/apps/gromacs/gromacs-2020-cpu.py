...
@rfm.simple_test
class gromacs_2020_cpu(rfm.RunOnlyRegressionTest):
    def __init__(self):
        self.descr = ('gromacs-2020-cpu modules CPU check'
        ...
        self.modules = ['gromacs/2020-cpu']
        self.valid_prog_environs = ['*']
        self.prerun_cmds = ['hostname']
        self.executable = 'mpirun -np 40 gmx_mpi'
