...
@rfm.simple_test
class gromacs_2019_2_gcc_9_2_0_openmpi(rfm.RunOnlyRegressionTest):
    def __init__(self):
        self.descr = ('gromacs/2019.2-gcc-9.2.0-openmpi modules CPU check'
        ...
        self.modules = ['gromacs/2019.2-gcc-9.2.0-openmpi','openmpi/3.1.5-gcc-9.2.0']
